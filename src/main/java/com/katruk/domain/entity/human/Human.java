...
public abstract class Human extends Model {
  ...
  public boolean equals(Object o) {
    ...
    if (getLastName() != null ? !getLastName().equals(human.getLastName())
                              : human.getLastName() != null) {
      return false;
    }
    if (getPatronymic() != null ? !getPatronymic().equals(human.getPatronymic())
                                : human.getPatronymic() != null) {
      return false;
    }
    if (getPassword() != null ? !getPassword().equals(human.getPassword())
                              : human.getPassword() != null) {
      return false;
    }
