	...
	@Override
	 public boolean equals(Object o) {
        ...
        if (getLastName() != null ? !getLastName().equals(teacher.getLastName()) : teacher.getLastName() != null)
            return false;
		if (getPatronymic() != null ? !getPatronymic().equals(teacher.getPatronymic()) : teacher.getPatronymic() != null)
            return false;
        if (getPassword() != null ? !getPassword().equals(teacher.getPassword()) : teacher.getPassword() != null)
            return false;
        if (getLogin() != null ? !getLogin().equals(teacher.getLogin()) : teacher.getLogin() != null)
            return false;
		if (getPosition() != null ? !getPosition().equals(teacher.getPosition()) : teacher.getPosition() != null)
            return false;
