...
public class Evaluation extends Model{
    ...
    public Evaluation(Discipline discipline, Student student, StatusInDiscipline status, Mark mark, String feedback) {
    ...
    public Evaluation(int id) { super(id); }
...
//	}
	...
	public boolean equals(Object o) {
		...
		if (getId() != evaluation.getId())
			return false;
		if (getDiscipline() != null ? !getDiscipline().equals(evaluation.getDiscipline()) : evaluation.getDiscipline() != null)
			return false;
		if (getStatus() != null ? !getStatus().equals(evaluation.getStatus()) : evaluation.getStatus() != null)
			return false;
		if (getMark() != null ? !getMark().equals(evaluation.getMark()) : evaluation.getMark() != null)
			return false;
		if (getFeedback() != null ? !getFeedback().equals(evaluation.getFeedback()) : evaluation.getFeedback() != null)
			return false;
		return (getStudent() != null ? !getStudent().equals(evaluation.getStudent()) : evaluation.getStudent() != null);
	}
